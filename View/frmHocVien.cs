...
namespace PBL3
{
    public partial class frmHocVien : Form
    {
        ...
        public void SetCBB()
        {
            cboHienThiHV.Items.Add(new CbbItem { value = "0", text = "all" });
        ...
        private void btnSuaHV_Click(object sender, EventArgs e)
        {
            ...
            if (dgvHienThiThongTinHV.SelectedRows.Count == 1)
            {
                ...
                MessageBox.Show("Chọn 1 row để sửa", "Sửa Học Viên", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        private void btnXoaHV_Click(object sender, EventArgs e)
        {
            if (dgvHienThiThongTinHV.SelectedRows.Count > 0)
            {
                ...
                MessageBox.Show("Chọn 1 row để xóa","Xóa Học Viên",MessageBoxButtons.OK,MessageBoxIcon.Error);
        }
